...
**`Desenvolvedor Fullstack | Node.js • Python • FastAPI • Fastify`**

Olá! Sou **Nadson Alex**, desenvolvedor fullstack em formação, 18 anos, pernambucano e estudante de **Ciência da Computação** na Unifavip Wyden — com bolsa integral pelo **PROUNI**.

Atualmente foco meus estudos e projetos em **APIs, back-end, automações e aplicações web modernas**, trabalhando principalmente com **Node.js**, **Python**, **FastAPI**, **Fastify**, além de PostgreSQL e SQLite. Também utilizo Docker, Git e ferramentas de testes/observabilidade.
...
<table>
  <tr>
    <td width="40" align="center">
      <img width="30" src="https://img.icons8.com/fluency/48/gmail-new.png"/>
    </td>
  ...
  <tr>
    <td width="40" align="center">
      <a href="https://www.instagram.com/nads.a06/" target="_blank">
        <img width="30" src="https://img.icons8.com/fluency/48/instagram-new.png"/>
      </a>
    </td>
  ...
  <tr>
    <td width="40" align="center">
      <a href="https://www.linkedin.com/in/nadsonalex/" target="_blank">
        <img width="30" src="https://img.icons8.com/fluency/48/linkedin.png"/>
      </a>
    </td>
